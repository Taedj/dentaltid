...
class DeveloperBroadcastsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DeveloperBroadcastsScreen> createState() =>
      _DeveloperBroadcastsScreenState();
}

class _DeveloperBroadcastsScreenState
    extends ConsumerState<DeveloperBroadcastsScreen> {
